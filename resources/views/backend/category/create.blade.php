...
<style>
    ...
    <div class="card card-default">
        ...
        <!-- /.card-header -->
        <form action="{{route('category.store')}}" method="Post"  id="image-form"  enctype="multipart/form-data">
       @csrf
       <div class="card-body">
            <div class="row">
                <div class="col-6">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="form-group ">
                                ...
                                <input data-on-text="Göster" data-off-text="Gösterme"  class="float-right" type="checkbox"  name="isSpecial" checked data-bootstrap-switch>

                            </div>
                            <label>{{__(('message.category_name'))}}</label>
                            <div class="form-group">
                                <input id="category_name" class="form-control-lg  form-control" name="name" value="{{old('name')}}" placeholder="{{__(('message.category_name'))}}">
            ...
            <div class="col-6 mt-5">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <input id="category_name" class="form-control-lg  form-control" name="category_slogan" value="{{old('category_slogan')}}"
                ...
                <div class="col-12 my-2">
                    <input class="form-control form-control-lg" placeholder="Kategori Açıklaması" >
                </div>
            </div>
            <div class="row">
                <button class="btn btn-primary" type="submit" id="submit-all"> @lang('message.add_category') </button>
            </div>
            <!-- /.row -->
       </div>
