...
@section('content')
    ...
    <div class="card card-default">
        ...
        <!-- /.card-header -->
        <form action="{{route('role.store')}}" method="Post"  id="image-form"  enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                ...
                <div class="row">
                    <button class="btn btn-primary" type="submit" id="submit-all"> Rol Adı </button>
                </div>
                <!-- /.row -->
            </div>
