...
@endpush
@section('currentPage','Limited Şirket')
@section('current_tab','Şirket Ekle   ')
@section('content')
    <style>
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Şirket Ekle   </h3>
        ...
        <form action="{{route('shop.store')}}" method="Post"  id="image-form"  enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="shop_type" value="3">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="form-group ">
                                ...
                                <input  class="form-control"  name="taxNumber" type="text" placeholder="Dükkan Vergi Numarası  ">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
